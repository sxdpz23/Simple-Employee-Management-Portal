...
public class EmployeeDTO {
	...
	public EmployeeTrainingDTO getTraining() {
		return training;
	}

	public void setTraining(EmployeeTrainingDTO training) {
